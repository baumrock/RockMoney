...
by(val){return new RockMoney(this.currency.value/val)}
float(){return this.currency.value}
format(){return this.toLocale()}
minus(val){return new RockMoney(this.currency.value-val)}
plus(val){return new RockMoney(this.currency.value+val)}
times(val){return new RockMoney(this.currency.value*val)}
